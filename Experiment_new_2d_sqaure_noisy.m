...
cvxprinter_master(A_am,struct('savepath',strcat('figures/Exp_2d_square_AM_nl',int2str(n))));
...
cvxprinter_master(A_LS,struct('savepath',strcat('figures/Exp_2d_square_LSE_nl',int2str(n))));
