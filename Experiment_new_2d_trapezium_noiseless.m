...
fprintf('####################################################################\n')
fprintf('#Reconstructing the trapezium in R^2 from noiseless support fn evals.#\n')
fprintf('####################################################################\n\n')
rng(626)
...
d = 3;
sigma = 0.0;
[u_mat_all, h_vec_all] = gen_cvxsupp('trapezium',n);
...
cvxprinter_master(A_am,struct('savepath',strcat('figures/2D/trapezium/Exp_2d_trapezium_AM_nl',int2str(n))));
...
cvxprinter_master(A_LS,struct('savepath',strcat('figures/2D/trapezium/Exp_2d_trapezium_LSE_nl',int2str(n))));
