...
my_cvxprinter_master(A_am,struct('savepath',strcat('figures/2D/L1_diamond/Exp_2d_diamond_AM_nl',int2str(n))));
...
my_cvxprinter_master(A_LS,struct('savepath',strcat('figures/2D/L1_diamond/Exp_2d_diamond_LSE_nl',int2str(n))));
